...
while looper:
    ...
    if y_position >= 0:
        ...
        thumby.display.drawText("S A R A H  B A S S", 5, y_position, 0)
        thumby.display.blit(starwhite, 5, y_position+5, 12, 10, 1, 0, 0) 
        thumby.display.blit(starwhite, 15, y_position+15, 12, 10, 1, 0, 0) 
        thumby.display.blit(moon, 30, y_position+5, 20, 23, 1, 1, 0) 
